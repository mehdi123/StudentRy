...
// Operations
public:
	void SortFarsi(long col, BOOL ascending = TRUE);
	void QuickSort(long first, long last);
	void Split(long first, long last, long &splitPoint);
	long GetRows();
...
private:
	BOOL m_ascending;
	BOOL m_numberSortFlag;
	void InterChange(long first, long splitPoint);
...
#endif // !defined(AFX_FLEXGRID_H__40F18E67_FE54_451C_AF21_DD9D09DC7F6F__INCLUDED_)
